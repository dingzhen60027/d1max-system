...
await build({entryPoints:['src/index.tsx'], bundle:true, outfile:'dist/extension.js', platform:'browser', format:'cjs', target:'es2022', minify:true, loader:{'.css':'text'}, define:{'process.env.NODE_ENV':'"production"'}});
